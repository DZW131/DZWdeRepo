...
def main():
    ...
    hqmr=source.get("hqmr_miou",source.get("observed",{}).get("hqmr"))
    passed=bool(source.get("pass") and checkpoint_ok and hqmr is not None and abs(float(hqmr)-0.6557244403737567)<=1e-12)
    result={"pass":passed,"checkpoint_sha256":sha256(a.checkpoint),"expected_checkpoint_sha256":EXPECTED_CHECKPOINT_SHA256,
            "hqmr_miou":hqmr,"source_m1_components":source.get("m1_components"),"source_m1_pixels":source.get("m1_pixels"),
