...
def main():
    ...
    add("Frozen inputs and reproduction gate",f"Checkpoint SHA-256 `{f['checkpoint_sha256']}`; BCSS validation contains {f['images']} images. All tensors came from the frozen HQMR forward path. The exact FP32-before-resize replay passed before evidence extraction, and the final prediction was bitwise checked against the sealed exact-baseline prediction bank.")
