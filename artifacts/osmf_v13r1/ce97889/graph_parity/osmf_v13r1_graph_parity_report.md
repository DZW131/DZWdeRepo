...
- grad(L_struct, p_morph): `0.0005514695658`
- grad(L_struct, u_morph): `0` (expected zero)
- grad(L_total, p_morph): `0.03593379259`
- grad(L_total, u_morph): `0.04023719952`
- Graph expectation pass: `True`
...
- A0/v1.3 mIoU: 0.6733598797 / 0.6733598797
- Absolute mIoU difference: 0
- A0/v1.3 mDice: 0.8027430371 / 0.8027430371
